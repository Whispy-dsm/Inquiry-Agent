...
export function createInternalEvidenceProviderFromEnv(
  ...
  const providerOptions = {
    github: {
      ...
      maxResults: env.INTERNAL_EVIDENCE_GITHUB_MAX_RESULTS,
      maxQueryTerms: env.INTERNAL_EVIDENCE_GITHUB_MAX_QUERY_TERMS,
      maxFetchedFileBytes: env.INTERNAL_EVIDENCE_GITHUB_MAX_FETCHED_FILE_BYTES,
    },
    notion: {
      ...
      maxResults: env.INTERNAL_EVIDENCE_NOTION_MAX_RESULTS,
      maxSearchTerms: env.INTERNAL_EVIDENCE_NOTION_MAX_SEARCH_TERMS,
      maxFetchedBlocks: env.INTERNAL_EVIDENCE_NOTION_MAX_FETCHED_BLOCKS,
    },
    embedding: {
