...
const envSchema = z.object({
  ...
  INTERNAL_EVIDENCE_GITHUB_MAX_RESULTS: z.coerce.number().int().positive().default(20),
  INTERNAL_EVIDENCE_GITHUB_MAX_QUERY_TERMS: z.coerce.number().int().positive().default(10),
  ...
  INTERNAL_EVIDENCE_NOTION_MAX_RESULTS: z.coerce.number().int().positive().default(10),
  INTERNAL_EVIDENCE_NOTION_MAX_SEARCH_TERMS: z.coerce.number().int().positive().default(10),
  INTERNAL_EVIDENCE_NOTION_MAX_FETCHED_BLOCKS: z.coerce.number().int().positive().default(300),
