...
describe('loadEnv', () => {
  it('should parse required environment values', () => {
    ...
    const input = {
      ...
      INTERNAL_EVIDENCE_GITHUB_MAX_RESULTS: '12',
      INTERNAL_EVIDENCE_GITHUB_MAX_QUERY_TERMS: '9',
      ...
      INTERNAL_EVIDENCE_NOTION_MAX_RESULTS: '14',
      INTERNAL_EVIDENCE_NOTION_MAX_SEARCH_TERMS: '11',
      INTERNAL_EVIDENCE_NOTION_MAX_FETCHED_BLOCKS: '350',
    ...
    expect(result.INTERNAL_EVIDENCE_GITHUB_MAX_RESULTS).toBe(12);
    expect(result.INTERNAL_EVIDENCE_GITHUB_MAX_QUERY_TERMS).toBe(9);
    ...
    expect(result.INTERNAL_EVIDENCE_NOTION_MAX_RESULTS).toBe(14);
    expect(result.INTERNAL_EVIDENCE_NOTION_MAX_SEARCH_TERMS).toBe(11);
    expect(result.INTERNAL_EVIDENCE_NOTION_MAX_FETCHED_BLOCKS).toBe(350);
  ...
  it('should default optional internal evidence settings', () => {
    ...
    expect(result.INTERNAL_EVIDENCE_GITHUB_MAX_RESULTS).toBe(20);
    expect(result.INTERNAL_EVIDENCE_GITHUB_MAX_QUERY_TERMS).toBe(10);
    ...
    expect(result.INTERNAL_EVIDENCE_NOTION_VERSION).toBe('2026-03-11');
    expect(result.INTERNAL_EVIDENCE_NOTION_MAX_RESULTS).toBe(10);
    expect(result.INTERNAL_EVIDENCE_NOTION_MAX_SEARCH_TERMS).toBe(10);
    expect(result.INTERNAL_EVIDENCE_NOTION_MAX_FETCHED_BLOCKS).toBe(300);
  ...
  it('should include internal evidence deployment template defaults', () => {
    ...
    for (const templatePath of templatePaths) {
      ...
      expect(template).toContain('INTERNAL_EVIDENCE_GITHUB_MAX_RESULTS: ${INTERNAL_EVIDENCE_GITHUB_MAX_RESULTS:-20}');
      expect(template).toContain('INTERNAL_EVIDENCE_GITHUB_MAX_QUERY_TERMS: ${INTERNAL_EVIDENCE_GITHUB_MAX_QUERY_TERMS:-10}');
      ...
      expect(template).toContain('INTERNAL_EVIDENCE_NOTION_MAX_RESULTS: ${INTERNAL_EVIDENCE_NOTION_MAX_RESULTS:-10}');
      expect(template).toContain('INTERNAL_EVIDENCE_NOTION_MAX_SEARCH_TERMS: ${INTERNAL_EVIDENCE_NOTION_MAX_SEARCH_TERMS:-10}');
      expect(template).toContain('INTERNAL_EVIDENCE_NOTION_MAX_FETCHED_BLOCKS: ${INTERNAL_EVIDENCE_NOTION_MAX_FETCHED_BLOCKS:-300}');
